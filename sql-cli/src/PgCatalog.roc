...
pgStatistic = {
    ...
    alias: "ps",
    columns: \alias -> {
        stainherit: identifier alias "stainherit" Sql.Types.bool,
        ...
        staattnum: identifier alias "staattnum" Sql.Types.i16,
        ...
        starelid: identifier alias "starelid" Sql.Types.i32,
...
pgStatisticExtData = {
    ...
    alias: "psed",
    columns: \alias -> {
        stxdinherit: identifier alias "stxdinherit" Sql.Types.bool,
        stxoid: identifier alias "stxoid" Sql.Types.i32,
...
pgAttribute = {
    ...
    columns: \alias -> {
        ...
        attnum: identifier alias "attnum" Sql.Types.i16,
...
pgInherits = {
    ...
    columns: \alias -> {
        ...
        inhseqno: identifier alias "inhseqno" Sql.Types.i32,
        inhparent: identifier alias "inhparent" Sql.Types.i32,
        inhrelid: identifier alias "inhrelid" Sql.Types.i32,
    },
}
...
pgAggregate = {
    ...
    columns: \alias -> {
        ...
        aggfnoid: identifier alias "aggfnoid" (Sql.Types.unsupported "regproc"),
...
pgAuthMembers = {
    ...
    columns: \alias -> {
        ...
        member: identifier alias "member" Sql.Types.i32,
        roleid: identifier alias "roleid" Sql.Types.i32,
    },
}
...
pgTsConfigMap = {
    ...
    alias: "ptcm",
    columns: \alias -> {
        mapseqno: identifier alias "mapseqno" Sql.Types.i32,
        maptokentype: identifier alias "maptokentype" Sql.Types.i32,
        mapdict: identifier alias "mapdict" Sql.Types.i32,
        mapcfg: identifier alias "mapcfg" Sql.Types.i32,
    },
}
...
pgReplicationOrigin = {
    ...
    columns: \alias -> {
        ...
        roident: identifier alias "roident" Sql.Types.i32,
    },
}
...
pgSeclabel = {
    ...
    columns: \alias -> {
        ...
        provider: identifier alias "provider" Sql.Types.str,
        classoid: identifier alias "classoid" Sql.Types.i32,
        objoid: identifier alias "objoid" Sql.Types.i32,
    },
}
...
pgRange = {
    ...
    columns: \alias -> {
        ...
        rngtypid: identifier alias "rngtypid" Sql.Types.i32,
    },
}
...
pgSequence = {
    ...
    columns: \alias -> {
        ...
        seqrelid: identifier alias "seqrelid" Sql.Types.i32,
    },
}
...
pgSubscriptionRel = {
    ...
    columns: \alias -> {
        ...
        srrelid: identifier alias "srrelid" Sql.Types.i32,
        srsubid: identifier alias "srsubid" Sql.Types.i32,
...
pgLargeobject = {
    ...
    columns: \alias -> {
        ...
        pageno: identifier alias "pageno" Sql.Types.i32,
        loid: identifier alias "loid" Sql.Types.i32,
    },
}
